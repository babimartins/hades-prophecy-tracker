...
describe('evaluate', () => {
  ...
  it('sums an all node', () => {
    const node: RequirementChild = { kind: 'all', of: ['a:one', 'a:two', 'a:three'] }
  ...
  it('completes an any node when one child is met', () => {
    const node: RequirementChild = { kind: 'any', of: ['a:one', 'a:two'] }
  ...
  it('caps a count node at n', () => {
    const node: RequirementChild = { kind: 'count', of: ['a:one', 'a:two', 'a:three'], n: 2 }
  ...
  it('measures an atLeast node against the threshold', () => {
    const node: RequirementChild = { kind: 'atLeast', fact: 'pact:extreme-measures', value: 4 }
